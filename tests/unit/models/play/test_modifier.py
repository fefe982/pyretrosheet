...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("BGDP", ModifierType.BUNT_DOUBLE_PLAY),
        ...
        ("LDP", ModifierType.DOUBLE_PLAY),
        ("LTP", ModifierType.TRIPLE_PLAY),
        ...
        ("BF", ModifierType.BUNT_FOUL),
        ("B", ModifierType.BUNT),
        ("BFDP", ModifierType.BUNT_FLY_INTO_DOUBLE_PLAY),
        ("B4S", ModifierType.BUNT),
        ("B34S", ModifierType.BUNT),
        ("B2R", ModifierType.BUNT),
        ("B25", ModifierType.BUNT),
        ("B2L", ModifierType.BUNT),
        ("B23F", ModifierType.BUNT),
        ("B2RF", ModifierType.BUNT),
        ("B6MS", ModifierType.BUNT),
        ("p", ModifierType.p),
        ("U", ModifierType.UNASSISTED),
        ("U1", ModifierType.UNASSISTED),
        ("l", ModifierType.l),
        ("U9R4", ModifierType.UNASSISTED),
        ("U4R6", ModifierType.UNASSISTED),
        ("U4R6", ModifierType.UNASSISTED),
        ("U7R64", ModifierType.UNASSISTED),
        ("U6R5U1", ModifierType.UNASSISTED),
        ("RR6", ModifierType.RR),
    ],
)
